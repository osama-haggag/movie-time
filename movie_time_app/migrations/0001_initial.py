# -*- coding: utf-8 -*-
# Generated by Django 1.11.1 on 2017-05-16 14:17
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('liked_or_not', models.SmallIntegerField(blank=True, choices=[(-1, 'bad'), (0, 'alright'), (1, 'liked')], null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Movie',
        ...
        migrations.AddField(
            model_name='likedornot',
            name='movie',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='movie_time_app.Movie'),
        ),
    ]
